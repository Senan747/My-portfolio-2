...
function HombugerMenu() {
  ...
  return (
    ...
    <div className=" w-full hidden max-xl:flex max-xl:fixed ">
      <HiOutlineMenuAlt4 className='text-6xl border-2 rounded-full border-gega-light text-gega-white bg-gega-black  hover:border-gega-green hover:text-gega-green  transition duration-300 m-2 p-4 cursor-pointer mt-10'
      ...
      /> 
        ...
        {showMenu && 
          <div className='bg-gega-dark w-96 h-screen pl-32 transition duration-1000 relative left-0 top-0 animate-[wiggle_2s_ease-in-out_2] animate-[pulse_1s_ease-in-out] max-xl:fixed z-50 max-md:w-64' ref={menuRef}>
            <p className='pb-20 pt-20'>Menu</p>

            <ul>
                <li className='pb-8'>
                    <Link to="#introduce" spy={true} smooth={true} offset={50} duration={500} className="flex flex-row group">
                ...
                <li className='pb-8'>
                    <Link to="#about" spy={true} smooth={true} offset={50} duration={500} className="flex flex-row group">
                ...
                <li className='pb-8'>
                    <Link to="#education" spy={true} smooth={true} offset={50} duration={500} className="flex flex-row group">
                ...
                <li className='pb-8'>    
                    <Link to="#skills" spy={true} smooth={true} offset={50} duration={500} className="flex flex-row group">
                ...
                <li className='pb-8'>
                    <Link to="#projects" spy={true} smooth={true} offset={50} duration={500} className="flex flex-row group">
