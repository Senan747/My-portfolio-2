    ...
    <div className='mt-24 mb-96 h-auto' id="projects">
      ...
      >
        ...
        <div className="bg-quiz-project bg-hover h-96 relative">
          <span className='absolute bottom-10 left-10 bg-gega-green text-gega-white px-8 py-1 font-bold rounded-lg'>Vue</span>
          <span className='absolute bottom-10 left-40 bg-gega-green text-gega-white px-8 py-1 font-bold rounded-lg'>CSS</span>
          <div className='w-full h-full absolute bg-gega-green flex items-center justify-center opacity-0 hover:opacity-100 transition duration-1000' style={style}>
      ...
      <div className='flex flex-row justify-between w-full flex-wrap'>
        <div className='bg-editor-project h-[370px] min-w-[370px] bg-cover relative mb-10 max-md:w-full'>
          <span className='absolute bottom-10 left-10 bg-gega-green text-gega-white px-8 py-1 font-bold rounded-lg'>JS</span>
          <span className='absolute bottom-10 left-40 bg-gega-green text-gega-white px-8 py-1 font-bold rounded-lg'>HTML</span>
          <div className='w-full h-full absolute bg-gega-green flex items-center justify-center opacity-0 hover:opacity-100 transition duration-1000' style={style}>
